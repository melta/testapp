...
mkdir /home/vagrant/testapp/logs
touch /home/vagrant/testapp/logs/gunicorn_supervisor.log
touch /etc/supervisor/conf.d/testapp.conf
cat <<EOT >> /etc/supervisor/conf.d/testapp.conf
[program:testapp]


command = /home/vagrant/testapp/bin/gunicorn_start.bash
user = vagrant
stdout_logfile = /home/vagrant/testapp/logs/gunicorn_supervisor.log
